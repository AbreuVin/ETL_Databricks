...
spark_df_licitacoes.write.mode("overwrite").option("mergeSchema", "true").saveAsTable("items_licitacoes_2023")

# COMMAND ----------

spark_df = spark.createDataFrame(df)
spark_df.write.mode("overwrite").saveAsTable("licitacoes_2023")